...
?><img src="/bitrix/templates/textiletorg/aks-img/o-nas/konkurs.png" style="float:right; margin: 0 0px 5px 40px;" alt="">
...
<p class="text-center" style="text-align: center"><a class="button yellow fancybox m-hidden" href="#competition" title="Оставить заявку на участие в следующем конкурсе" style="display: inline-block!important;background: #F5EB27;border-radius: 0 0 10px 10px;text-decoration: none;padding: 8px 40px;cursor: pointer;font-weight: 700;">Оставить заявку на участие в следующем конкурсе</a></p>
