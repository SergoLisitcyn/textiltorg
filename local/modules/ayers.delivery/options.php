...
$module_id = 'ayers.delivery'; //обязательно, иначе права доступа не работают!
...
$aTabs = array(
    array(
        ...
        'OPTIONS' => array(
            array('IP_MANAGERS', 'IP адреса:', '', array('text', 30)),
            array('note' => 'IP адреса для просмотра дополнительной информации в карточке товара.')
        )
    ),
);
