...
$arrTargetCategory = array(19,977);
$arrTargetProducts = array();
$arOutOfStock = array(12284);
$arElementsXml = $obBitrixMarket->GetElementsXmlGoogleMS($arrTargetCategory, $arrTargetProducts, $arOutOfStock);
