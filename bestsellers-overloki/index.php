...
$APPLICATION->SetPageProperty("description", "Ищете оверлок и не знаете, как выбрать лучший? Тогда прочитайте статью, в ней раскрыты основные различия и характеристики оверлоков для дома. Также вы сможете задать интересующие вопросы и заказать лучший оверлок для себя. | ТекстильТорг");
$APPLICATION->SetTitle("Как выбрать хороший оверлок и не ошибиться? ");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PROPERTY_CODE" => array(
			...
			1 => "GUARANTEE",
			2 => "CHAR_TIP_MASHINY",
			3 => "CHAR_KOLICHESTVO_NITEJ",
			4 => "CHAR_PROSHIVAEMYE_MATERIALY",
			5 => "CHAR_REGULIROVKA_DAVLENIYA_LAPKI_NA_TKAN",
			6 => "CHAR_KOLICHESTVO_SHVOV", //
			7 => "CHAR_MAKSIMALNAYA_SKOROST_SHITYA",
			8 => "CHAR_DIFFERENCIALNAYA_PODACHA_MATERIALA",
			9 => "CHAR_KONTROL_NATYAZHENIYA_NITEJ",
			10 => "CHAR_MUSOROSBORNIK",
