...
$videoMessageButtonId = '';
if(\Bitrix\Socialnetwork\Util::isShowVideoMessageSpotLight())
{
	CJSCore::Init("spotlight");
	$videoMessageButtonId = 'video-message-lighted-button';
}
...
HTML;
	...
	//						,"Important"
							...
							"BUTTONS_HTML" => Array("VideoMessage" => '<span class="feed-add-post-form-but-cnt feed-add-videomessage"'.($videoMessageButtonId ? ' id="'.$videoMessageButtonId.'" ': '').'onclick="BX.VideoRecorder.start(\''.$arParams["FORM_ID"].'\');">'.GetMessage('BLOG_VIDEO_RECORD_BUTTON').'</span>'),
							"ADDITIONAL" => array(
