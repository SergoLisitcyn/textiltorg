...
else if ($_POST['IM_LOAD_LAST_MESSAGE'] == 'Y')
{
	...
	if ($_POST['CHAT'] == 'Y')
	{
		...
		if (!$arMessage || $_POST['USER_LOAD'] == 'Y' && empty($arMessage['chat']) || isset($arMessage['chat'][$chatId]) && !in_array($arMessage['chat'][$chatId]['messageType'], Array(IM_MESSAGE_OPEN, IM_MESSAGE_CHAT, IM_MESSAGE_OPEN_LINE)))
		{
			$arMessage = Array();
			$error = 'ACCESS_DENIED';
		}
...
else if ($_POST['IM_CHAT_DATA_LOAD'] == 'Y')
{
	...
	{
		if (($arChat['chat'][$chatId]['messageType'] == IM_MESSAGE_OPEN || $arChat['chat'][$chatId]['messageType'] == IM_MESSAGE_OPEN_LINE) && CModule::IncludeModule("pull"))
		{
