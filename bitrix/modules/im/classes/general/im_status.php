				...
				'params' => Array(
					'users' => Array(
						$userId => Array(
							...
							'idle' => $status['IDLE'] instanceof \Bitrix\Main\Type\DateTime? $status['IDLE']->getTimestamp(): 0,
							'mobileLastDate' => $status['MOBILE_LAST_DATE'] instanceof \Bitrix\Main\Type\DateTime? $status['MOBILE_LAST_DATE']->getTimestamp(): 0,
	...
	public static function GetList($params = Array())
	{
		...
		if ($loadFromDb)
		{
			...
			while ($user = $orm->fetch())
			{
				...
				$user['IDLE'] = $user['IDLE'] instanceof \Bitrix\Main\Type\DateTime? $user['IDLE']->getTimestamp(): 0;
				$user['MOBILE_LAST_DATE'] = $user['MOBILE_LAST_DATE'] instanceof \Bitrix\Main\Type\DateTime? $user['MOBILE_LAST_DATE']->getTimestamp(): 0;
				$user['LAST_ACTIVITY_DATE'] = $user['LAST_ACTIVITY_DATE'] instanceof \Bitrix\Main\Type\DateTime? $user['LAST_ACTIVITY_DATE']->getTimestamp(): 0;
