...
//$arResult["TITLE"] = 'Не забудьте! Товары, нужные для эксплуатации данного товара.';
$arResult["TITLE"] = 'Не забудьте! Товары, нужные для эксплуатации ' . $arParams["ELEMENT_NAME"];