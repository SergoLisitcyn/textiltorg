...
$APPLICATION->SetPageProperty("FILTER_COUNT", $arResult["NAV_RESULT"]->NavRecordCount);
...
if ($arResult["UF_ACTION"] && empty($arResult["UF_H1_TITLE"]) && empty($arResult["UF_ACTION_MORE"]))
{
	$arResult["SECTION_ACTION"] = '<div class="eshop-cat-detailed"><div class="eshop-cat-detailed__announce"><div class="attention">#TEXT#</div></div></div>';
	$arResult["SECTION_ACTION"] = str_replace("#TEXT#", $arResult["~UF_ACTION"], $arResult["SECTION_ACTION"]);
	$APPLICATION->SetPageProperty("CATALOG_ACTION", $arResult["SECTION_ACTION"]);
}

if ($arResult["UF_H1_TITLE"])
{

	$arResult["SECTION_H1_TITLE"] = '<h1 class="catalog-action-title'.(empty($arResult["UF_ACTION_MORE"]) ? '-single' : '').'">'.$arResult["UF_H1_TITLE"].'</h1>';
	
	$APPLICATION->SetPageProperty("CATALOG_SECTION_H1_TITLE", $arResult["SECTION_H1_TITLE"]);
}
if ($arResult["UF_ACTION_MORE"])
{
	$arResult["SECTION_ACTION_MORE"] = '<div class="section-title-action-description">#TEXT#</div>';
	$arResult["SECTION_ACTION_MORE"] = str_replace("#TEXT#", $arResult["~UF_ACTION_MORE"], $arResult["SECTION_ACTION_MORE"]);
	$arResult["SECTION_ACTION_MORE"] = str_replace("#DATE#", date("t.m.Y"), $arResult["SECTION_ACTION_MORE"]);
	
	$APPLICATION->SetPageProperty("CATALOG_ACTION_MORE", $arResult["SECTION_ACTION_MORE"]);
}
