...
$_GET["LAST_PAGE"] = $arResult["NavPageCount"];
?>
...
<div class="text">
    ...
    <?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
        <? $APPLICATION->AddHeadString("<link rel='prev' href=".$arResult['sUrlPath']."?".$strNavQueryString."PAGEN_".$arResult["NavNum"]."=".($arResult['NavPageNomer']+1).">") ?>
    ...
    <?if ($arResult["NavPageNomer"] > 1):?>
        <? $APPLICATION->AddHeadString("<link rel='next' href=".$arResult["sUrlPath"]."?".$strNavQueryString."PAGEN_".$arResult["NavNum"]."=".($arResult["NavPageNomer"]-1).">"); ?>
