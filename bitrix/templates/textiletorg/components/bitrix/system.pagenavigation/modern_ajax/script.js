$(function() {
    ...
    $(".gridlist .grid-btn").click(function() {
        $("#n_grid_items").removeClass("itemlist");
        $("#n_grid_items").addClass("itemgrid");
    ...
    $(".gridlist .list-btn").click(function() {
        $("#n_grid_items").removeClass("itemgrid");
        $("#n_grid_items").addClass("itemlist");
