...
?>
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>" id="catalog-filter">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			<div class="bx-filter-button-box">
				<div class="bx-filter-parameters-box-container">
					<button class="btn btn-themes" id="close-filter">Закрыть поиск</button>
					<input
						class="btn btn-link"
						type="submit"
						id="top_del_filter"
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							...
							<?if ($arItem["HELP_ID"]):?>
								<a title="Характеристики товара" class="help-filter" href="/help/?block=7&id=<?=$arItem["HELP_ID"]?>">?</a>
							<?endif?>
										...
										<label class="bx-filter-param-label" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
											<span class="bx-filter-input-checkbox">
												<input
													...
													ontouchstart="smartFilter.click(this)"
												/>
					...
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container">
							...
							<input
								...
								value="<?=GetMessage("CT_BCSF_SET_FILTER")?>"
							/>
							<div class="filter_button red bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> >
