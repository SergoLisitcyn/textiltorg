	...
	*/ ?>
        ...
        if ($arResult["bDescPageNumbering"] === true):
            ...
            if ($arResult["NavPageNomer"] > 1):
                ...
                <a class="modern-page-next"
                   href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] - 1) ?>">След</a>
            <?
            endif;
            ...
            if ($arResult["NavPageNomer"] > 1):
                if ($arResult["bSavePage"]):
                    ?>
                    <a class="pager__button pager__button_type_next next_page_link"
                       href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] - 1) ?>"><?= GetMessage("nav_prev") ?></a>
                <?
                else:
        ...
        if ($arResult["bShowAll"]):
            if ($arResult["NavShowAll"]):
                ?>
                <a class="pager__button pager__button_type_next"
