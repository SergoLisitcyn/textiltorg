...
<div id="<?=htmlspecialcharsbx($containerId)?>" class="bx-sender-segment-edit-wrapper">
	...
	<form name="post_form" method="post" action="<?=htmlspecialcharsbx($arResult['SUBMIT_FORM_URL'])?>">
		...
		<div class="bx-sender-letter-field" style="display: none;">
			<div class="bx-sender-caption">
			...
			<div class="bx-sender-value">
				...
				<div class="sender-group-address-counter">
					...
					if(count($arResult['CONNECTOR']['AVAILABLE']) > 0):
						?>
						<div data-bx-button="" class="webform-small-button webform-small-button-blue webform-button-icon-triangle-down">
							<span class="webform-small-button-text"><?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_BTN_ADD')?></span>
					...
					<span class="sender-group-address-counter-text"><?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_SUM')?>:</span>
					<span data-bx-counter="" class="sender-group-address-counter-cnt"><?
						echo intval($arResult['CONNECTOR']['EXISTED_ADDRESS_COUNT'])
					?></span><?
					?><span style="<?=($arParams['DATA_TYPE_ID'] ? 'display: none;' : '')?>"><?
						?><span class="">, <?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_SUM_OF')?> </span>
		...
		<script type="text/template" id="connector-template-filter">
			...
			>
				...
				<div class="sender-box-close" style="display: none;">
		...
		<script type="text/template" id="connector-template">
			<?
			ob_start();
			?><div data-bx-item="%CONNECTOR_NUM%" data-code="%CONNECTOR_MODULE_ID%_%CONNECTOR_CODE%" class="sender-box-list-item sender-box-list-item-hidden connector_form">
				<div data-bx-item-toggler="" class="sender-box-list-item-caption">
					...
					<span data-bx-item-remove="" class="sender-mailing-sprite sender-box-list-item-caption-delete"></span>
					<span class="sender-box-list-item-caption-additional">
						<span class="sender-box-list-item-caption-additional-less">
							<?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_SELECTED')?>:
						</span>
						<span data-bx-item-counter="" class="connector_form_counter">%CONNECTOR_COUNT%</span>
						<span style="<?=($arParams['DATA_TYPE_ID'] ? 'display: none;' : '')?>">
							<span class="">, <?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_SUM_OF')?> </span>
							<span data-bx-item-count-info="%CONNECTOR_COUNTER%" class=""></span>
						</span>
				...
				<div class="sender-box-list-item-block connector_form_container">
					...
					<div>
						<span data-bx-item-close="" class="webform-small-button webform-small-button-transparent">
		...
		<div class="sender-box-list">
			<div class="sender-box-name"><?=Loc::getMessage('SENDER_SEGMENT_EDIT_TMPL_LIST')?></div>
