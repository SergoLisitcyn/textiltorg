...
class SenderSegmentEditComponent extends CBitrixComponent
{
	...
	protected function initParams()
	{
		...
		if (isset($this->arParams['ONLY_CONNECTOR_FILTERS']))
		{
			$this->arParams['ONLY_CONNECTOR_FILTER'] = (bool) $this->arParams['ONLY_CONNECTOR_FILTER'];
		}
		else
		{
			$this->arParams['ONLY_CONNECTOR_FILTERS'] = false;
		}
		...
		$this->arParams['CAN_VIEW_CONN_DATA'] = isset($this->arParams['CAN_VIEW_CONN_DATA']) ? $this->arParams['CAN_VIEW_CONN_DATA'] : Security\User::current()->isPortalAdmin();
	}
