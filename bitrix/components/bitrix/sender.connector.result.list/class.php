...
class SenderConnectorResultListComponent extends CBitrixComponent
{
	...
	protected function initParams()
	{
		...
		$this->arParams['CAN_VIEW'] = isset($this->arParams['CAN_VIEW']) ? $this->arParams['CAN_VIEW'] : Security\User::current()->isPortalAdmin();
	...
	protected function prepareResult()
	{
		...
		{
			$this->errors->setError(new Error(Security\AccessChecker::getMessage(Security\AccessChecker::ERR_CODE_VIEW)));
			return false;
		}
