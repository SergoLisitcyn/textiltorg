...
class SenderStartComponent extends CBitrixComponent
{
	...
	protected function prepareResult()
	{
		...
		$this->arResult['MESSAGES'] = array(
			'MAILING' =>  $this->getSenderMessages(Message\Factory::getMailingMessages()),
			'ADS' =>  $this->getSenderMessages(Message\Factory::getAdsMessages()),
			'RC' =>  $this->getSenderMessages(Message\Factory::getReturnCustomerMessages()),
		);
