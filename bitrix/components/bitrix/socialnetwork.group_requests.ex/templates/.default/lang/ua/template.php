...
$MESS["SONET_GRE_T_SUBTITLE_IN_PROJECT"] = "Запити на вступ в проект";
$MESS["SONET_GRE_T_SUBTITLE_OUT_PROJECT"] = "Запрошення для вступу в проект";
$MESS["SONET_GRE_T_NO_REQUESTS_DESCR_PROJECT"] = "Тут показуються запити користувачів на вступ до  проекту.";
$MESS["SONET_GRE_T_NO_REQUESTS_OUT_DESCR_PROJECT"] = "Тут показуються запрошення користувачам для вступу до проекту.";
$MESS["SONET_GRE_T_INVITE_PROJECT"] = "Запросити до проекту";
...
$MESS["SONET_GRE_T_NO_REQUESTS2_PROJECT"] = "На даний момент запитів користувачів на вступ в проект немає";
$MESS["SONET_GRE_T_NO_REQUESTS2_OUT"] = "На даний момент запрошень користувачів для вступ до групи немає";
$MESS["SONET_GRE_T_NO_REQUESTS2_OUT_PROJECT"] = "На даний момент запрошень користувачів для вступ в проект немає";
$MESS["SONET_GRE_T_ERROR"] = "Сталася помилка обробки запиту";
