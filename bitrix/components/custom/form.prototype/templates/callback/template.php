...
<div class="fancybox_block form_callback" id="form_callback" style="display: none;">
    <div class="form_callback_block">
        <form action="<?= $APPLICATION->GetCurPage()?>" method="post" class="callback-form" id="<?=$arResult["TAG_MANAGER"]?>">
            <?=bitrix_sessid_post()?>
            ...
            <div style="text-align:center">
                <button type="submit" class="red_button" onclick="<?=Helper::GetYandexCounter("callMe_Send")?>">Жду звонка!</button>
            </div>
        </form>
    </div>
