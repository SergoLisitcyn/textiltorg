...
$arResult = array_merge($arResult, KhayRComment::Show($arParams, array("ID", "IBLOCK_ID", "IBLOCK_SECTION_ID", "NAME", "PREVIEW_TEXT", "PREVIEW_PICTURE", "PROPERTY_*"), array("PROPERTY_DATE" => "DESC"), $arNavParams));
