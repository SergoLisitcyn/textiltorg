    ...
    <div id="as-stores-page">
        <div class="as-stores-page-list">
            <?if ($arResult['ITEMS']['HOME']):?>
                <div class="as-stores-page-title title">Магазины</div>
                <?foreach ($arResult['ITEMS']['HOME'] as $nItem => $arItem):?>
                    <div class="as-stores-page-item">
                        ...
                        <?if ($arItem['METRO']):?>
                            <div ><span class="icon-metro"></span><?=$arItem['METRO']?></div>
                        <?endif?>
                        <?if ($arItem['TIME']):?>
            ...
            <?if ($arResult['ITEMS']['STORES']):?>
                <div class="as-stores-page-title title">Пункты выдачи *</div>
