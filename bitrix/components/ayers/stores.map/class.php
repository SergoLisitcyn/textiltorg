        ...
        if ($arItems['HOME'])
        {
            ...
            foreach ($arItems['HOME'] as $arItem)
            {
                ...
                $items[] = (object) array(
                    ...
                    'phone' => $arItem['PHONE'],
                    'hint' => 'Перед самовывозом необходимо забронировать товар. <div class="red-btn2-wrap"><span class="red-btn2" onclick="chose_point();return false;">забрать отсюда</span></div><br><br>'
                );
            }
        ...
        if ($arItems['STORES'])
        {
            ...
            foreach ($arItems['STORES'] as $arItem)
            {
                ...
                $items[] = (object) array(
                    ...
                    'time' => preg_replace('/\;/', '<br>', $arItem['TIME']),
                    'phone' => $arItem['PHONE'],
                    'hint' => '<span class="red">*</span> Самовывоз из магазина – это лучший вариант. В нём мы проведём бесплатный мастер класс по демонстрации функционала модели, а квалифицированный персонал ответит на любые вопросы и при необходимости научат основам работы со швейной техникой.<br>Перед самовывозом необходимо забронировать товар. <span class="red-btn2" onclick="chose_point();return false;">забрать отсюда</span><br><br>'
                );
            }
