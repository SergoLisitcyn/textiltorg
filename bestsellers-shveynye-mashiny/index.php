...
$APPLICATION->SetPageProperty("description", "Не знаете какую выбрать швейную машинку ? Прочитайте статью и узнаете основные различия и характеристики. А так же вы сможете найти лучший бренд для дома и сразу оформить заказ на выбранную швейную машину");
$APPLICATION->SetTitle("Какая швейная машина лучше?");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PROPERTY_CODE" => array(
			...
			5 => "CHAR_KOLICHESTVO_OPERACIJ",
			6 => "CHAR_NITEVDEVATEL",
			7 => "CHAR_MAKSIMALNAYA_SKOROST_SHITYA",
			8 => "CHAR_REGULIROVKA_DAVLENIYA_LAPKI_NA_TKAN",
			9 => "CHAR_VYPOLNENIE_PETEL",
			10 => "CHAR_OBREZKA_NITEJ",
			11 => "CHAR_SEMNAYA_RUKAVNAYA_PLATFORMA",
			12 => "",
		),
		"SECTION_ID" => "19",
